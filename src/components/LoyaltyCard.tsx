    ...
    <div className="glassmorphism rounded-[32px] p-8 shadow-2xl text-text relative overflow-hidden border border-white/20 group transition-all hover:scale-[1.02]">
      ...
      <div className="flex items-center gap-5 mb-8 relative z-10">
        ...
        <div className="flex-1">
          ...
          <p className="text-2xl font-bold italic tracking-tight text-primary">Loyalty Code: {user?.cardNumber || '---'}</p>
        </div>
        {onOpenRules && (
          <button 
            onClick={onOpenRules}
            ...
            >
              {showSuccess ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <h2 className="text-xl font-bold italic text-primary leading-relaxed">
                    {lang === 'sw' 
                ...
                <>
                  <div className="flex justify-between items-start mb-8">
                    <div>
                      <h2 className="text-2xl font-bold italic text-primary">{lang === 'sw' ? 'Chagua Zawadi Yako' : 'Choose Your Reward'}</h2>
