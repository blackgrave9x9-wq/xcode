      ...
      {orderToDelete && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4">
          <div className="glassmorphism p-8 rounded-[32px] shadow-2xl space-y-6 max-w-sm w-full border border-white/10">
            <h2 className="text-2xl font-bold italic text-primary">{t(user.language || 'en', 'confirmDelete')}</h2>
      ...
      <div className="max-w-7xl mx-auto glassmorphism rounded-[40px] p-8 sm:p-12 shadow-2xl border border-white/10">
        <header className="flex flex-col sm:flex-row justify-between items-center mb-12 gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold italic">Admin Portal</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <main className="lg:col-span-3 space-y-8">
            {activeTab === 'orders' ? (
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-6 mb-8">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="font-bold italic text-xl text-primary">{order.customerName || users.find(u => u.uid === order.userId)?.displayName || 'Unknown Customer'}</p>
              ...
              <div className="space-y-6">
                <h2 className="text-2xl font-bold italic text-primary mb-6">Active Subscriptions</h2>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-6 mb-6">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-bold italic text-xl text-primary">{users.find(u => u.uid === sub.userId)?.displayName || 'Unknown Customer'}</p>
                ...
                <div className="mt-12">
                  <h3 className="text-xl font-bold italic text-primary mb-6 flex items-center gap-2">
              ...
              <div className="space-y-6">
                <h2 className="text-2xl font-bold italic text-primary mb-6">Loyalty Redemptions</h2>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-6 mb-6">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-bold italic text-xl text-primary">{redemption.userName}</p>
              ...
              <>
                ...
                {importStatus && (
                  <div className={`p-4 rounded-lg mb-4 ${importStatus.type === 'success' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
              ...
              <div className="glassmorphism p-10 rounded-[32px] space-y-10 border border-white/10 shadow-2xl">
                <h3 className="text-2xl font-bold italic flex items-center gap-3 text-primary">
                ...
                <div className="pt-10 border-t border-white/10 space-y-8">
                  <h4 className="text-lg font-bold italic text-primary flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col gap-4">
                        <label className="w-full p-4 bg-white/5 border border-dashed border-white/20 rounded-xl cursor-pointer hover:bg-white/10 transition-all flex flex-col items-center justify-center gap-2">
                          <Upload size={20} className="text-primary/60" />
                          <span className="text-xs font-bold text-text/40 uppercase tracking-widest">Click to upload image</span>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    <button 
                      ...
                      className="flex-1 py-4 bg-primary text-white rounded-2xl font-bold shadow-xl shadow-primary/20 hover:bg-secondary transition-all transform active:scale-95 flex items-center justify-center gap-2"
                    >
                      <Save size={20} />
                      APPLY POP-UP AD
                    </button>
