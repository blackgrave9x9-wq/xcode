  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h2 className="text-2xl font-bold italic mb-2">{t(lang, 'loginRequired')}</h2>
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-12 gap-4">
        <div>
          <h1 className="text-5xl sm:text-6xl font-bold italic tracking-tight mb-2">{t(lang, 'subscriptionTitle')}</h1>
      ...
      {isLoading ? (
        ...
        <div className="glassmorphism border border-white/10 rounded-[40px] p-20 text-center shadow-2xl">
          ...
          <h3 className="text-3xl font-bold italic mb-4">{t(lang, 'noActiveSubs')}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {subscriptions.map((sub) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold italic mb-2">{sub.productName}</h3>
            ...
            >
              <div className="p-6 sm:p-12">
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h2 className="text-2xl sm:text-3xl font-bold italic mb-2">{t(lang, 'newSubscription')}</h2>
