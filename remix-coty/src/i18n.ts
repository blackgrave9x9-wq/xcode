...
export const translations = {
  en: {
    ...
    // Footer
    footerDesc: "Redefining the essence of butchery and market excellence. A curated experience for the discerning palate.",
    ...
    aiThinkingVision: "LYRA is analyzing your selection...",
    chefAdvice: "Chef's Elite Advice",
    prestigeMembership: "Prestige Membership",
  ...
  sw: {
    ...
    // Footer
    footerDesc: "Tunafafanua upya maana ya ubora wa bucha na soko. Uzoefu maalum kwa wateja wetu.",
    ...
    aiThinkingVision: "LYRA anachambua picha yako...",
    chefAdvice: "Ushauri wa Mpishi Bingwa",
    prestigeMembership: "Uanachama wa Kifahari",
